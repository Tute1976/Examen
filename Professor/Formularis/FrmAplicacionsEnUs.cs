...
namespace Examen.Professor.Formularis
{
    public partial class FrmAplicacionsEnUs : FormAdv
    {
        ...
        private void MenuLlista_Opening(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            menuAturar.Image = Suport.Properties.Resources.Aturar_16x16;
            ...
            switch (item.BackColor.ToString())
            {
                ...
                default: // Normal
                    ...
                    foreach (var categoria in _contenidorAplicacions.Categories)
                        menuAturar.DropDownItems.Add(categoria, Suport.Properties.Resources.Aturar_16x16, MenuAturar_Categoria_Click);
                    break;
            }
        }
        ...
        private void MenuDesar_Click(object sender, EventArgs e)
        {
            ...
            _contenidorAplicacions.CategoriesAplicacions.Desar(_fitxer, out var json);
